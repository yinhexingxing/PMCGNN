...
# import algorithm   # If the Summation Algorithm is not installed, you can use the preprocessed file and comment out that line.
...
def get_train_val_loaders(
    ...
    def PE_data(rawdata,PE_k):
        # Precompute necessary statistics for positional encodings.
        pe_enabled_list = ['RRWP']
        ...
        if pe_enabled_list:
            ...
            is_undirected = all(d.is_undirected() for d in rawdata[:10])
            ...
            """
            pre_transform_in_memory(rawdata,
    ...
    train_data = PE_data(train_data, K)
